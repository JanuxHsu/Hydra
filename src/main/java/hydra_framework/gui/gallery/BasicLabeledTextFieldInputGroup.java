package hydra_framework.gui.gallery;
...
public class BasicLabeledTextFieldInputGroup extends JPanel {
	...
	public BasicLabeledTextFieldInputGroup(Map<String, JTextField> inputs) {
