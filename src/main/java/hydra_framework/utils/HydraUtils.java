...
import hydra_framework.main_start.HydraMain;
...
public class HydraUtils {
	...
	public static String getRunningJarName() {
		...
		String hydraJarName = new File(HydraMain.class.getProtectionDomain().getCodeSource().getLocation().getPath())
				.getName();
